...
public class BillController {
    ...
    @PostMapping
    public BillDto craeteBill(@RequestBody BillDto billDto)
    {
        return billService.createBill(billDto);
    }

    @GetMapping("/{billNumber}")
    public BillDto getBillByBillNumber(@PathVariable String billNumber)
    {
    ...
    public BillDto payDueAmount(@PathVariable String billNumber, @RequestParam BigDecimal amount)
    {
        return billService.payDueAmount(billNumber,amount);
    }

    @DeleteMapping("/{billNumber}")
    public String deleteBill(@PathVariable String billNumber)
    {
